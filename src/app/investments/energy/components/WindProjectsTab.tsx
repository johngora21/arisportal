...
import { Wind, MapPin, Users, TrendingUp, Zap, Fan, Gauge, X } from 'lucide-react';
import { EnergyProject } from '../models';

interface WindProjectsTabProps {
...
export default function WindProjectsTab({
  projects = [],
  searchTerm,
  setSearchTerm,
  typeFilter,
  ...
  const getWindIcon = (technology: string) => {
    if (technology?.toLowerCase().includes('offshore')) return <Fan size={16} />;
    if (technology?.toLowerCase().includes('onshore')) return <Gauge size={16} />;
    return <Wind size={16} />;
  };
  ...
  return (
    <div>
      ...
      <div style={{
        ...
        <input
          type="text"
          placeholder="Search wind projects..."
          value={searchTerm}
        ...
        >
          <option value="all">All Wind</option>
          <option value="onshore">Onshore Wind</option>
            ...
            >
              <div style={{
                ...
                <div style={{
                  ...
                  {getWindIcon(project.technology || '')} Wind
                </div>
              </div>
