...
import { MapPin, DollarSign, Users, TrendingUp, Calendar, X, Factory, Package } from 'lucide-react';
import { AgricultureProject } from '../models';

// Declare Leaflet types
declare const L: any;

interface AgroProcessingTabProps {
...
export default function AgroProcessingTab({ 
  projects = [], 
  searchTerm = '', 
  setSearchTerm, 
  typeFilter = 'all',
      ...
      marker.bindPopup(`
        <div style="padding: 8px; font-family: 'Poppins', sans-serif; min-width: 200px;">
          ...
          <p style="margin: 0 0 4px 0; font-size: 14px; color: #059669;">
            Processing: ${selectedProjectForMap.processingType || 'N/A'}
          </p>
  ...
  const getProcessingIcon = (processingType: string) => {
    switch (processingType?.toLowerCase()) {
      case 'maize processing': return '🌽';
      case 'rice processing': return '🌾';
      case 'coffee processing': return '☕';
      case 'oil processing': return '🫒';
      case 'dairy processing': return '🥛';
      case 'meat processing': return '🥩';
      case 'fish processing': return '🐟';
      case 'sugar processing': return '🍯';
      default: return '🏭';
    }
  };
  ...
  return (
    <div>
      ...
      <div style={{
        ...
        <input
          type="text"
          placeholder="Search agro processing projects..."
          value={searchTerm}
        ...
        >
          ...
          <option value="sugar processing">Sugar Processing</option>
        </select>
      </div>
      ...
      {projects.length === 0 ? (
        <div style={{
          ...
          <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#6b7280', margin: '16px 0 8px 0' }}>
            No agro processing projects available
          </h3>
          <p style={{ fontSize: '14px', color: '#9ca3af', margin: 0 }}>
            Check back later for new processing investment opportunities
          </p>
        </div>
      ) : (
        <div style={{
            ...
            >
              <div style={{
                ...
                <div style={{
                  ...
                  {getProcessingIcon(project.processingType || '')} {project.processingType}
                </div>
              </div>
