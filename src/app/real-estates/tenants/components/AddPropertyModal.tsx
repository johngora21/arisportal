...
export default function AddPropertyModal({ isOpen, onClose, onSave }: AddPropertyModalProps) {
  ...
  const handleAddUnit = () => {
    ...
    const unit: Unit = {
      ...
      type: newUnit.type,
      size: parseFloat(newUnit.size) || 0,
      ...
      kitchen: newUnit.kitchen,
      sittingRoom: newUnit.sittingRoom,
      totalArea: newUnit.totalArea
    };
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '16px', marginBottom: '24px', width: '100%', maxWidth: '100%' }}>
              ...
              <div style={{ gridColumn: '1 / -1' }}>
                ...
                <div style={{ 
                    ...
                    <>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        <input
                          ...
                          onChange={(e) => setNewUnit({...newUnit, kitchen: parseInt(e.target.value) || 0})}
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                            border: '1px solid #d1d5db',
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        <input
                          ...
                          onChange={(e) => setNewUnit({...newUnit, sittingRoom: parseInt(e.target.value) || 0})}
                          style={{
                            width: '100%',
                            padding: '12px 16px',
                            border: '1px solid #d1d5db',
                  ...
                  {(selectedPropertyType === 'commercial' || selectedPropertyType === 'mixed-use') && (
                    <div style={{ flex: 1 }}>
                        <label style={{ fontSize: '12px', fontWeight: '500', color: '#6b7280', marginBottom: '4px', display: 'block' }}>
                          Total Area (sqm) *
                        </label>
                      <input
                        ...
                        onChange={(e) => setNewUnit({...newUnit, totalArea: parseInt(e.target.value) || 0})}
                        style={{
                          width: '100%',
                          padding: '12px 16px',
                          border: '1px solid #d1d5db',
                      ...
                      {propertyUnits.map((unit) => (
                        <div key={unit.id} style={{
                          ...
                          <span style={{ fontSize: '14px', color: '#374151' }}>
                            {unit.unitNumber} - {selectedPropertyType === 'residential' 
                              ? `${unit.bedrooms}BR, ${unit.bathrooms}BA, ${unit.kitchen}K, ${unit.sittingRoom}SR` 
