...
import { MapPin, DollarSign, Users, TrendingUp, Calendar, X, Hotel } from 'lucide-react';
import { InfrastructureProject } from '../models';

// Declare Leaflet types
declare const L: any;

interface HospitalityProjectsTabProps {
...
export default function HospitalityProjectsTab({ 
  projects = [], 
  searchTerm = '', 
  setSearchTerm, 
  typeFilter = 'all',
  ...
  // Mock data for hospitality infrastructure projects
  const mockProjects: InfrastructureProject[] = [
    {
      id: 'hosp-1',
      title: 'Serena Business Hotel',
      category: 'hospitality',
      description: 'Luxury business hotel with conference facilities, spa, and premium dining options in Mikocheni.',
      ...
      status: 'active',
      totalProjectValue: 750000000,
      minimumInvestment: 8000000,
      currentInvestors: 18,
      targetInvestors: 45,
      fundingProgress: 40,
      investmentDeadline: 'May 2025',
      features: ['Luxury Rooms', 'Conference Facilities', 'Spa & Wellness', 'Premium Dining', 'Business Center'],
    ...
    },
    {
      ...
      category: 'hospitality',
      description: 'Exclusive beachfront resort with villas, restaurants, and water sports facilities.',
      ...
      targetInvestors: 35,
      fundingProgress: 34,
      investmentDeadline: 'Aug 2025',
      features: ['Beach Villas', 'Restaurants', 'Water Sports', 'Spa Services', 'Conference Center'],
      image: '/api/placeholder/400/300',
      coordinates: { lat: -5.7269, lng: 39.2938 }
    },
    {
      id: 'hosp-3',
      title: 'Arusha Safari Lodge',
      category: 'hospitality',
      description: 'Premium safari lodge with luxury tents and wildlife viewing facilities near Serengeti.',
      ...
      features: ['Luxury Tents', 'Wildlife Viewing', 'Restaurant', 'Spa', 'Guided Tours'],
      image: '/api/placeholder/400/300',
  ...
  return (
    <div>
      ...
      <div style={{
        ...
        <input
          type="text"
          placeholder="Search hospitality projects..."
          value={searchTerm}
      ...
      <h2 style={{ fontSize: '24px', fontWeight: '600', color: '#1f2937', marginBottom: '24px' }}>
        Hospitality Infrastructure Projects
      </h2>
      ...
      {displayProjects.length === 0 ? (
        <div style={{
          ...
          <Hotel size={48} color="#9ca3af" />
          <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#6b7280', margin: '16px 0 8px 0' }}>
            No hospitality projects available
          </h3>
          <p style={{ fontSize: '14px', color: '#9ca3af', margin: 0 }}>
            Check back later for new hospitality infrastructure opportunities
          </p>
        </div>
      ) : (
        <div style={{
