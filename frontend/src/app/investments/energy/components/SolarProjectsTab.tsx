...
import { Sun, MapPin, Users, TrendingUp, Zap, Battery, Plug, X } from 'lucide-react';
import { EnergyProject } from '../models';

interface SolarProjectsTabProps {
...
export default function SolarProjectsTab({
  projects = [],
  searchTerm,
  setSearchTerm,
  typeFilter,
  ...
  const getSolarIcon = (technology: string) => {
    if (technology?.toLowerCase().includes('rooftop')) return <Plug size={16} />;
    if (technology?.toLowerCase().includes('tracking')) return <Battery size={16} />;
    return <Sun size={16} />;
  };
    ...
    <div>
      ...
      <div style={{
        ...
        >
          ...
          <option value="concentrated">Concentrated Solar</option>
        </select>
      </div>
            ...
            >
              <div style={{
                ...
                <div style={{
                  ...
                  {getSolarIcon(project.technology || '')} Solar
                </div>
              </div>
