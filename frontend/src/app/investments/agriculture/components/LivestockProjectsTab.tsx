...
import { MapPin, DollarSign, Users, TrendingUp, Calendar, X, TreePine, Heart } from 'lucide-react';
import { AgricultureProject } from '../models';

// Declare Leaflet types
declare const L: any;

interface LivestockProjectsTabProps {
...
export default function LivestockProjectsTab({ 
  projects = [], 
  searchTerm = '', 
  setSearchTerm, 
  typeFilter = 'all',
      ...
      marker.bindPopup(`
        <div style="padding: 8px; font-family: 'Poppins', sans-serif; min-width: 200px;">
          ...
          <p style="margin: 0 0 4px 0; font-size: 14px; color: #059669;">
            Livestock: ${selectedProjectForMap.livestockType || 'N/A'}
          </p>
  ...
  const getLivestockIcon = (livestockType: string) => {
    switch (livestockType?.toLowerCase()) {
      case 'dairy cattle': return '🐄';
      case 'beef cattle': return '🐂';
      case 'goats': return '🐐';
      case 'sheep': return '🐑';
      case 'pigs': return '🐷';
  ...
  return (
    <div>
      ...
      <div style={{
        ...
        <input
          type="text"
          placeholder="Search livestock projects..."
          value={searchTerm}
      ...
      {projects.length === 0 ? (
        <div style={{
          ...
          <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#6b7280', margin: '16px 0 8px 0' }}>
            No livestock projects available
          </h3>
          <p style={{ fontSize: '14px', color: '#9ca3af', margin: 0 }}>
            Check back later for new livestock investment opportunities
          </p>
        </div>
      ) : (
        <div style={{
            ...
            >
              <div style={{
                ...
                <div style={{
                  ...
                  {getLivestockIcon(project.livestockType || '')} {project.livestockType}
                </div>
              </div>
              ...
              <div style={{ padding: '20px', flex: 1 }}>
                ...
                <div style={{ 
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                    <Heart size={12} />
                    <span>Count: {project.livestockCount?.toLocaleString()}</span>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                    <TreePine size={12} />
